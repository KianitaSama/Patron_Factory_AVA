 ...
 * @author kianaA
 */
public class Lenovo implements MovilCelular{
    private int Ram;
    private String Procesador;
    private int Camara;
    private String Color;
    private String Modelo;
   // public String name = MovilCelular.LENOVO;

    public Lenovo(int Ram, String Procesador, int Camara, String Color, String Modelo) {
        this.Ram = Ram;
