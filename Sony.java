 ...
 * @author kianaA
 */
public class Sony implements MovilCelular  {
    private int Ram;
    private String Procesador;
    private int Camara;
    private String Color;
    private String Modelo;
    public String name = MovilCelular.SONY;

    public Sony(int Ram, String Procesador, int Camara, String Color, String Modelo) {
        this.Ram = Ram;
